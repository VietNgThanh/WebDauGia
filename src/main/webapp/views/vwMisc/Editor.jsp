...
<jsp:useBean id="laycata" scope="request" type="java.util.List<com.ute.webdaugia.beans.ChildCategory>"/>
...
<t:main>
  ...
  <jsp:attribute name="js">
    <script src="https://cdn.tiny.cloud/1/72cy11ulks4a1ppl672suqffj22srp1aa8ovhwo7vflzvn18/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
      tinymce.init({
        selector: '#txtFullDes',
        height: 450,
